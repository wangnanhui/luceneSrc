...
public abstract class MultiLevelSkipListWriter {
  ...
  public void bufferSkip(int df) throws IOException {
    ...
    while ((df % skipMultiplier) == 0 && numLevels < numberOfSkipLevels) {
      numLevels++;//skipMultiplier 默认为8 这里是为了定位在哪一层 比如 192 / 8  = 24 --> 24 / 8 = 3   numLevels = 2 
      //如果df为127 那么直接是最后一层了 因为skipList的每一层都是一个区间 默认skipLevel为128 那么127 所以127就是在 0 - 127 这个范围内 
